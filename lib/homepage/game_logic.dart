...
///List is a class
///ContainsAll extension name
///containsAll is a function
///any type of List can contain this extension
///z is an optional parameter
///using (this.contains() the same with( Player.playerX.contains() it refers to the object that called the method ,i can also remove this and it will be the same
